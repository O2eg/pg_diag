...
select
  ...
  w.in_recovery,
  case when w.in_recovery then 1 else 0 end as in_recovery_int,
  ...
  round(
    extract(epoch from pg_catalog.clock_timestamp() - pg_catalog.pg_last_xact_replay_timestamp())::numeric,
    3
