...
MIN_SUPPORTED_PG_VERSION = 100000
MAX_SUPPORTED_PG_VERSION = 189999

SUPPORTED_CONTENT_SCHEMA_VERSION = 4
ARTIFACT_SCHEMA_VERSION = 5

OBJECT_DDL_TIMEOUT_SECONDS = 180.0
OBJECT_DDL_STATEMENT_TIMEOUT_MS = 5000
OBJECT_DDL_LOCK_TIMEOUT_MS = 4000
...
DATABASE_RECONNECT_ATTEMPTS = 5
DATABASE_RECONNECT_DELAY_SECONDS = 3.0
DATABASE_RECONNECT_CONNECT_TIMEOUT_SECONDS = 5.0
DATABASE_CONNECTION_CLOSE_TIMEOUT_SECONDS = 5.0

HOST_COMMAND_TIMEOUT_SECONDS = 5.0
MAX_SHELL_SOURCE_TIMEOUT_SECONDS = 1.0
MAX_LOCAL_PYTHON_SOURCE_TIMEOUT_SECONDS = 30.0
