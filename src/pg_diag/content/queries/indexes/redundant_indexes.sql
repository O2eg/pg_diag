...
select
  ...
  'The redundant index key is a structural left prefix; confirm plans, INCLUDE coverage, constraints, and workload before removal.' as pg_diag_internal_reason
from index_data i1
join index_data i2
...
where i1.indnkeyatts >= i2.indnkeyatts
  ...
  and i1.key_array[1:i2.indnkeyatts] = i2.key_array[1:i2.indnkeyatts]
