...
pair_roots_bounded as (
  ...
  where i1.indnkeyatts >= i2.indnkeyatts
    and not i2.indisunique
    and (i1.indnkeyatts > i2.indnkeyatts or i1.indexrelid > i2.indexrelid)
...
index_pairs as (
  ...
  where i1.key_array[1:i2.indnkeyatts] = i2.key_array[1:i2.indnkeyatts]
    and i1.class_array[1:i2.indnkeyatts] = i2.class_array[1:i2.indnkeyatts]
    and i1.collation_array[1:i2.indnkeyatts] = i2.collation_array[1:i2.indnkeyatts]
    and i1.option_array[1:i2.indnkeyatts] = i2.option_array[1:i2.indnkeyatts]
...
select
  ...
  case
    when coverage.root_sample_truncated
      ...
      then 'The redundant-index result is based on truncated root, per-table, pair, or output samples; confirm plans, INCLUDE coverage, constraints, and workload before removal.'
    else 'The redundant index key is a structural left prefix; confirm plans, INCLUDE coverage, constraints, and workload before removal.'
